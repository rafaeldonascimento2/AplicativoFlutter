  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        scaffoldBackgroundColor: Color(0xFFFAF0DC),   // Cor de fundo do app (bege claro)
        appBarTheme: AppBarTheme( // Estilo da barra superior
        ...
        bottomNavigationBarTheme: BottomNavigationBarThemeData( // Estilo da barra de navegação inferior
